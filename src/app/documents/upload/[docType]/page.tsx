...
export default function UploadDocPage() {
  ...
  return (
    <PageShell title={t(`documents.${dt}`)} showBack showTabs={false}>
      <div className="space-y-3">
        ...
        <button onClick={fromDigi} className="block w-full text-left rounded-card border-[1.5px] border-brand bg-white px-4 py-4 hover:bg-brand-50/40 transition-colors">
        ...
        <label className="block w-full text-left rounded-card border border-line bg-white px-4 py-4 hover:border-brand-200 cursor-pointer transition-colors">
          <div className="flex items-center gap-3">
