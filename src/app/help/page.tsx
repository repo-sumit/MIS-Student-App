  ...
  return (
    <div className="app-shell flex min-h-[100dvh] flex-col bg-white">
      ...
      <main className="px-5 pt-2 pb-10">
        <h1 className="text-[22px] font-bold text-ink">{t("help.title")}</h1>
        <p className="text-[13px] text-ink-muted mt-1 mb-5">{t("help.subtitle")}</p>
          ...
          <a href={`tel:${t("help.phone")}`}>
            <Card padded>
              <div className="flex items-center gap-3">
                ...
                <div className="text-[13px] font-bold text-brand whitespace-nowrap">{t("help.phone")}</div>
              </div>
            </Card>
          </a>
