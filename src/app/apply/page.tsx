...
export default function ApplyHub() {
  ...
  if (!profileReady) {
    return (
      <PageShell title={t("apply.hubTitle")} size="medium">
        <EmptyState
  ...
  return (
    <PageShell title={t("apply.hubTitle")} size="wide">
      <div>
        <div className="mb-4">
          <h1 className="text-[22px] sm:text-[26px] font-bold text-ink">{t("apply.hubTitle")}</h1>
          <p className="text-[13px] text-ink-muted">{t("apply.hubSubtitle")}</p>
        </div>
