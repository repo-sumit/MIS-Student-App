...
export default function SubmittedConfirmation() {
  ...
  const isAfterSubmitted = step === "underScrutiny" || step === "meritPublished" || step === "allotted" || step === "admissionConfirmed";

  return (
    <PageShell title={t("apply.submittedTitle")} showBack showTabs={false}>
      <div className="space-y-3">
        <Card padded>
          <div className="flex flex-col items-center text-center py-4">
            ...
            <h2 className="mt-3 text-[18px] font-bold text-ink">{t("apply.submittedTitle")}</h2>
            <p className="text-[13px] text-ink-muted mt-1 max-w-[280px]">{t("apply.submittedBody")}</p>
          </div>
        ...
        {isAfterSubmitted && (
          <Card padded>
            <CardTitle>Demo override</CardTitle>
            <CardSubtitle>This application is now showing the demo stage.</CardSubtitle>
          </Card>
        )}
